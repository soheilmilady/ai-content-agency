...
این پروژه برای استفاده در محیط‌های پرفشار و حساس (Bulletproof) بهینه‌سازی شده است:
- **Rate Limiting:** استفاده از `slowapi` برای دفع حملات Brute-force در لاگین و جلوگیری از خالی شدن بودجه دلاری اکانت LLM در مسیرهای تولید مقاله.
...
- **Soft Delete:** جلوگیری از از بین رفتن مقالات هنگام حذف کاربران.
